...
`docs/screenshots/accessible-chart.png` captures the real chart with its exact-values table expanded. It is generated by `tests/e2e/accessibility.spec.ts`, not an image mockup.
